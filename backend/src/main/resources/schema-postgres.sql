...
INSERT INTO plugins (id, slug, name, description, verification_message, created_at)
VALUES (
    CAST('10000000-0000-0000-0000-000000000001' AS UUID), 'cloudfashion', 'CloudFashion',
    '角色时装与外观管理插件', 'CloudFashion 授权验证通过', CURRENT_TIMESTAMP
)
...
INSERT INTO plugins (id, slug, name, description, verification_message, created_at)
VALUES (
    CAST('10000000-0000-0000-0000-000000000002' AS UUID), 'cloudchest', 'CloudChest',
    '云端仓库与物品管理插件', 'CloudChest 授权验证通过', CURRENT_TIMESTAMP
)
ON CONFLICT (slug) DO UPDATE SET
    name = EXCLUDED.name,
    description = EXCLUDED.description,
